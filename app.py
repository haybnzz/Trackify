# Copyright 2024 Trackify, created by Hay.Bnz. All rights reserved.

# Licensed under the Creative Commons Attribution-NonCommercial 4.0 International License (CC BY-NC 4.0).
#
# Under this license:
# - **Attribution**: You must give appropriate credit to "Hay.Bnz" as the creator of Trackify. Include a link to the license
#   and indicate if changes were made. Attribution must not suggest the licensor endorses you or your use.
...
# - Redistribution: You may share the software with others under the same license, provided appropriate attribution
#   is given and the modifications are clearly indicated.
# - No Warranty: The software is provided "as is," without warranty of any kind, express or implied.
#
# For more details on the license, visit:
#     https://creativecommons.org/licenses/by-nc/4.0/
#
# Permissions beyond the scope of this license, including commercial use, may be available upon request. For inquiries,
# please contact the author at cubedimension@protonmail.com.
#
